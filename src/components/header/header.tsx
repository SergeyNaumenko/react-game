...
type HeaderProps = {
  ...
  onShowScoreView: Function,
}

const Header = ({onShowConfigView, onShowScoreView}: HeaderProps) => {
  return (
      ...
      <Container>
        <Row className='d-flex'>
          ...
          <Col className='d-flex justify-content-end align-content-end'>
            <Button className='header-btn me-3' onClick={() => onShowScoreView()}>
            ...
            <Button className='header-btn' onClick={() => onShowConfigView()}>
              <svg className='header-config-icon' xmlns='http://www.w3.org/2000/svg' width='30' height='30' viewBox='0 0 16 16'>
